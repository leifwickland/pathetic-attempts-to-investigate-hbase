...
class Project(info: ProjectInfo) extends DefaultProject(info) with ProguardProject {
  ...
  override def mainClass: Option[String] = Some("play.countsByUser")
  ...
  override def packageOptions = ManifestAttributes(
    MAIN_CLASS -> "play.countsByUser",
    IMPLEMENTATION_TITLE -> "play.countsByUser",
    IMPLEMENTATION_URL -> "http://play.countsByUser.org/",
    IMPLEMENTATION_VENDOR -> "play.countsByUser.org",
    SEALED -> "true") :: Nil
  ...
  override def proguardOptions = List(
    proguardKeepMain("play.countsByUser"),
    proguardKeepMain("play.countsByUser$"),
